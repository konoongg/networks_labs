...
3) Модифицируйте программу, чтобы  отбрасывались только TCP-пакеты, секция данных которых начианется с SPAM, DDOS
4) Модифицируйте программу, чтобы  отбрасывались только TCP-пакеты, секция данных которых содержит протокол bitTorrent
